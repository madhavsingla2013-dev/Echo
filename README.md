...
* **Space** — Jump
* **R** — Reset your run manually (creates an echo right where you stand)
* **Esc** (or the top-right button) — Pause, change character colors, or jump back to level select

Your goal is simple: reach the **green exit**. If a jump looks impossible or a gap is too wide, drop into the pit on purpose to build yourself a bridge!
